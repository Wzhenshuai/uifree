    ...
    <div id="themeSwitch" class="dropdown">
        ...
        <ul class="dropdown-menu">
            <c:forEach items="${fns:getDictList('theme')}" var="dict">
                <li>
                    <a href="#"
                       onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href">${dict.label}
                    </a>
                </li>
            </c:forEach>
        </ul>
...
<div class="footer">
    ...
    <a href="http://uifree.xyz" target="_blank">uifree.xyz</a> ${fns:getConfig('version')}
</div>
